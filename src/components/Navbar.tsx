  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/5 bg-background/80 backdrop-blur-xl">
      <div className="container mx-auto flex items-center justify-between py-5 md:py-6 px-4">
        <a href="#" className="flex items-center gap-3 md:gap-3.5">
          <img src={logo} alt="Gênio Visual" className="h-[55px] w-[55px] md:h-[70px] md:w-[70px] object-contain flex-shrink-0" style={{ filter: 'drop-shadow(0 0 8px hsl(189 98% 51% / 0.35))' }} />
